-- AFRFMS dev database schema (SQLite via Node's built-in node:sqlite).
-- For production, this schema translates directly to PostgreSQL — see the
-- Architecture Document (Section 5) for the full target entity list.
-- This foundation covers Airports, Roles, Users, and enough of the fleet
-- hierarchy to demonstrate airport-scoped access control end to end.
